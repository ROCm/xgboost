...
inline void CheckComputeCapability() {
  for (int d_idx = 0; d_idx < xgboost::curt::AllVisibleGPUs(); ++d_idx) {
...
// MemoryLogger and GlobalMemoryLogger defined in device_vector.cuh
...
// XGBDefaultDeviceAllocatorImpl, XGBCachingDeviceAllocatorImpl and allocator aliases from device_vector.cuh
